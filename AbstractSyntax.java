...
class Program {
    ...
    void display() {
    	...
    	decpart.display(branch+"¦§");
    	body.display(branch+"¦¦");
    	System.out.println("End Program");
    }
    void display(String branch) {
    	System.out.println(branch+"Program");
...
// Declaration = Variable v; Type t
	...
	void display(String branch) {
		System.out.println(branch+"Declaration");
		if(branch.charAt(branch.length()-1)=='¦¦') {
			branch = branch.substring(0, branch.length()-1) + "¡¡";
		}else {
			branch = branch.substring(0, branch.length()-1) + "¦¢";
		...
		System.out.println(branch+"¦§"+"Type\t: "+t.toString());
		System.out.println(branch+"¦¦"+"Variable\t: "+v.toString());
	}
}
...
abstract class Statement {
	...
	abstract void display(String branch);
}
...
class Block extends Statement {
	...
	void display(String branch) {
		System.out.println(branch+"Block");
		if(branch.charAt(branch.length()-1)=='¦¦') {
			branch = branch.substring(0, branch.length()-1) + "¡¡¦§";
		}else {
			branch = branch.substring(0, branch.length()-1) + "¦¢¦§";
		...
		int num_of_members = members.size();
...
class Assignment extends Statement {
    ...
    void display(String branch) {
		...
		System.out.println(branch+"¦§"+"Variable\t: "+target.toString());
		source.display(branch+"¦¦");
	}
}
...
// Conditional = Expression test; Statement thenbranch, elsebranch
    ...
    void display(String branch) {
		...
		test.display(branch+"¦§");
		if(elsebranch==null) {
			thenbranch.display(branch+"¦¦");
		}else {
			thenbranch.display(branch+"¦§");
			elsebranch.display(branch+"¦¦");
		}
	}
}
...
// Loop = Expression test; Statement body
    ...
    void display(String branch) {
		System.out.println(branch+"Loop");
		if(branch.charAt(branch.length()-1)=='¦¦') {
			branch = branch.substring(0, branch.length()-1) + "¡¡";
		}else {
			branch = branch.substring(0, branch.length()-1) + "¦¢";
...
class Variable extends Expression {
    ...
    void display(String branch) {
    	System.out.println(branch+"Variable\t: "+id);
    }
}
...
// Binary = Operator op; Expression term1, term2
    ...
    void display(String branch) {
		System.out.println(branch+op.toString());
		if(branch.charAt(branch.length()-1)=='¦¦') {
			branch = branch.substring(0, branch.length()-1) + "¡¡";
		}else {
			branch = branch.substring(0, branch.length()-1) + "¦¢";
		}
		term1.display(branch+"¦§");
		term2.display(branch+"¦¦");
    }
}
